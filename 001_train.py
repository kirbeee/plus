...
def train(args):
    ...
    feature_extractor = Mamba_Hash_Net(embedding_size=args.dim, do_prob=args.dropout).to(args.device)
    ...
    for epoch in range(args.epochs):
        ...
        if avg_loss < best_loss:
            ...
            torch.save(feature_extractor.state_dict(), os.path.join(args.model_root, f'{args.dataset}_feature_extractor.pth'))
            torch.save(generator.state_dict(), os.path.join(args.model_root, f'{args.dataset}_best_generator.pth'))
